...
Item
{
    ...
    property string survey: svg + "<svg width='83' height='83' viewBox='0 0 83 83' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M25.0024 43.6812L35.609 54.2878L59.297 30.5998' stroke='black' stroke-width='6'/><rect x='3.50195' y='3.49316' width='76' height='76' rx='19.5' stroke='black' stroke-width='7'/></svg>"
