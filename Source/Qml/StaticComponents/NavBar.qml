...
Item
{
    ...
    property string strokeColor: Style.mainColor
    ...
    Rectangle
    {
        ...
        color: Style.isDarkTheme ? "#FAFF00" : "#985DFB"

        ShaderEffect
        {
            property point origin: Qt.point(0.5, 0.5)
            property point radius: Qt.point(1.0, 1.0)
            property color zeroColor: Style.isDarkTheme ? "#FF6B00" : "#6100FF"
            property color oneColor: Style.isDarkTheme ? "#FAFF00" : "#985DFB"
